...
<%@ page import="com.fh.entity.qizhe.ProjectAuditHelperHans" %>
<%
	request.setAttribute("upperCaseInfo", ProjectAuditHelperHans.UPPER_CASE_INFO);
	request.setAttribute("projectHelp", ProjectAuditHelperHans.PROJECT_HELP);
	request.setAttribute("projectInfos", ProjectAuditHelperHans.PROJECT_INFO);
...
<body>
<form action="hans/${msg }.do" name="Form" id="Form" method="post" onsubmit="alert('提交成功')">
...
<%--
				<tr class="text-center">
					...
					<c:if test="${pd.ID != null}">
						...
						<td>
							<a href="<%=basePath%>hans/auditPage.do?projectName=a01&ID=${pd.ID}">网点申诉</a>
							<c:choose>
...
<%--		<tr>
        ...
        function addImage(id, projectName){
            ...
            diag.Drag=true;
            diag.Title ="新增图片";
            diag.URL = '<%=basePath%>hans/goImageAdd.do?id=' + id + '&projectName=' + projectName;
            diag.Width = 600;
            diag.Height = 500;
        ...
        function imageDeal(id, projectName){
            ...
            diag.Drag=true;
            diag.Title ="查看图片";
            diag.URL = '<%=basePath%>hans/getImageDeal.do?id=' + id + '&projectName=' + projectName;
            diag.Width = 600;
            diag.Height = 500;
            diag.CancelEvent = function(){ //关闭事件
                diag.close();
        ...
        function audit(scpcid, projectName, id){
            ...
            diag.Drag=true;
            diag.Title ="查看图片";
            diag.URL = '<%=basePath%>hans/auditAdd.do?scpcid=' + scpcid + '&projectName=' + projectName + "&id=" + id;
            diag.Width = 600;
            diag.Height = 500;
            diag.CancelEvent = function(){ //关闭事件
				debugger;
