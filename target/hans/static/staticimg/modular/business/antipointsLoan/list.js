...
LoginLog.initColumn = function () {
    return [
        ...
        {title: '渠道名', field: 'message', align: 'center', valign: 'middle', sortable: true},
        {title: '开户行', field: 'ip1', align: 'center', valign: 'middle', sortable: true},
        {title: '开户账号', field: 'ip2', align: 'center', valign: 'middle', sortable: true},
        {title: '债权期限', field: 'ip3', align: 'center', valign: 'middle', sortable: true},
        {title: '返点额度', field: 'ip4', align: 'center', valign: 'middle', sortable: true},
        {title: '业务类型', field: 'ip4', align: 'center', valign: 'middle', sortable: true},
        {title: '合同编号', field: 'ip6', align: 'center', valign: 'middle', sortable: true}
    ];
};
