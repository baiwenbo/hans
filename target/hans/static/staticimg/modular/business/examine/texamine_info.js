...
*/
 ...
 $.when( 		
 		$.getJSON('/texamine/findEvaluationPictures?orderId='+orderId,function (data) {
...
$.when( 
 		$.getJSON('/texamine/findCustomerPictures?orderId='+orderId,function (data) {	
 ...
 $.when( 
		 $.getJSON('/texamine/findContractPictures?orderId='+orderId,function (data) {
