...
*/
 ...
 $.when( 		
 		$.getJSON('/debt/findEvaluationPictures?orderId='+orderId,function (data) {
...
$.when( 
 		$.getJSON('/debt/findCustomerPictures?orderId='+orderId,function (data) {	
 ...
 $.when( 
		 $.getJSON('/debt/findContractPictures?orderId='+orderId,function (data) {
