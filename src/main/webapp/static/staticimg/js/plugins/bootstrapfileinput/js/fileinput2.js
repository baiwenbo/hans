...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tPreview = '<div class="file-preview {class}">\n' +
                ...
                '    </div>\n' +
                '</div>';
            tClose = '<div class="close fileinput-remove hide">&times;</div>\n';
            ...
            tIndicator = '<div class="file-upload-indicator hide" title="{indicatorTitle}">{indicator}</div>';
        ...
        _initZoomButton: function () {
            ...
            //图片绑定打开幻灯片
            self.$preview.find('.explorer-frame .kv-file-content img').each(function () {
                var $el = $(this);
                self._handler($el, 'click', function () {
                    self._zoomPreview($el);
                });
        ...
        _initPreviewActions: function () {
            var self = this, $preview = self.$preview, deleteExtraData = self.deleteExtraData || {},
                btnRemove = $h.FRAMES + ' .kv-file-remove', array = [] ,
            ...
            $preview.find(btnRemove).each(function () {
                ...
                self._handler($el, 'click', function () {
                    ...
                    else if ( self._raise('filepredelete') ) {
                        return false;
                    }  
                    else {
                        var n, cap;
                            ...
                            array.push(vUrl)
                            $el.closest('.file-input').attr('data-del',function(){
                                return  array
                            })
        ...
        _setFileDropZoneTitle: function () {
            ...
            $zone.find('.weui-uploader__input-box').remove();
            ...
            // }      
            $zone.find('.file-preview-thumbnails').append('<div class="weui-uploader__input-box"><div class="weui-uploader__input" ></div></div>')
            
            // self._handler(self.$container.find('.weui-uploader__input'), 'click', $.proxy(self._uploadClick, self));
            $zone.find('.file-preview-thumbnails .weui-uploader__input').on('click',function(){ 
                       $(this).closest('.file-input').find('.btn-file input').trigger('click')
            })
    ...
    $.fn.fileinput.defaults = {
        ...
        mainClass: 'file-caption-main hide',
        mainTemplate: null,
        purifyHtml: true,
        fileSizeGetter: null,
        initialCaption: '',
