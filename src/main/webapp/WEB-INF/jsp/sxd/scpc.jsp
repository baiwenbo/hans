...
<%@ page import="com.fh.entity.qizhe.ProjectAuditHelperSXD" %>
<%
	request.setAttribute("upperCaseInfo", ProjectAuditHelperSXD.UPPER_CASE_INFO);
	request.setAttribute("projectHelp", ProjectAuditHelperSXD.PROJECT_HELP);
	request.setAttribute("projectInfos", ProjectAuditHelperSXD.PROJECT_INFO);
...
<body>
<form action="sxd/${msg }.do" name="Form" id="Form" method="post" onsubmit="alert('提交成功')">
			...
			<td><table   class="table table-bordered" border="1" width="1000">
				...
				<tr class="text-center">
					...
					<c:if test="${pd.ID != null}">
						...
						<td>
							<a href="<%=basePath%>sxd/auditPage.do?projectName=${name}&ID=${pd.ID}">网点申诉</a>
						</td>
					</c:if>
				</tr>
				</c:forEach>
...
<%--
				<tr class="text-center">
					...
					<c:if test="${pd.ID != null}">
						...
						<td>
							<a href="<%=basePath%>sxd/auditPage.do?projectName=a01&ID=${pd.ID}">网点申诉</a>
							<c:choose>
...
<%--		<tr>
		...
		<tr class="text-center">
			...
			<td><table   class="table table-bordered" border="1" width="1000">
				...
				<tr class="text-center">
					<td width="10%" align="left" valign="top">员工建议（本门店那些做的好，不好的有没有合理的想法，的）：</td>
        ...
        function addImage(id, projectName){
            ...
            diag.Drag=true;
            diag.Title ="新增图片";
            diag.URL = '<%=basePath%>sxd/goImageAdd.do?id=' + id + '&projectName=' + projectName;
            diag.Width = 600;
            diag.Height = 500;
        ...
        function imageDeal(id, projectName){
            ...
            diag.Drag=true;
            diag.Title ="查看图片";
            diag.URL = '<%=basePath%>sxd/getImageDeal.do?id=' + id + '&projectName=' + projectName;
            diag.Width = 600;
            diag.Height = 500;
            diag.CancelEvent = function(){ //关闭事件
                diag.close();
        ...
        function audit(scpcid, projectName, id){
            ...
            diag.Drag=true;
            diag.Title ="查看图片";
            diag.URL = '<%=basePath%>sxd/auditAdd.do?scpcid=' + scpcid + '&projectName=' + projectName + "&id=" + id;
            diag.Width = 600;
            diag.Height = 500;
            diag.CancelEvent = function(){ //关闭事件
				debugger;
