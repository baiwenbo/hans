	...
	<form action="happuser/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr class="info">
				...
				<td><input class="span10 date-picker" name="START_TIME" id="START_TIME" value="<fmt:formatDate value="${pd.START_TIME}" pattern="yyyy-MM-dd"/>" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="开通日期"  title="开通日期"/></td>
			</tr>
			</c:if>
			<c:if test="${pd.ROLE_ID == '1'}">
