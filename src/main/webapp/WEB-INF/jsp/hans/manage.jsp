...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="hans/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="KEYW" value="" placeholder="这里输入关键词" />
							<input style="width: 100px;" class="span10 date-picker" id ="dataMonth" name="dataMonth" value="${pd.dataMonth}"  type="text" data-date-format="yyyy-mm" readonly="readonly" placeholder="审核月份"  title="审核月份" datefmt="yyyy-MM" />
		...
		<table style="width:100%;">
			<tr>
				<td style="vertical-align:top;">
					...
					<c:if test="${QX.del == 1 }">
						<a class="btn btn-small btn-success" onclick="add1();">申诉审核</a>
					</c:if>
				</td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
        ...
        function add1(){
            ...
            diag.Drag=true;
            diag.Title ="申诉审核";
            diag.URL = '<%=basePath%>hans/check.do';
            diag.Width = 1960;
            diag.Height = 1020;
            diag.CancelEvent = function(){ //关闭事件
                if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>hans/goEdit.do?ID='+Id;
			 diag.Width = 1960;
			 diag.Height = 1020;
			 diag.CancelEvent = function(){ //关闭事件
                 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>hans/excel.do?dataMonth='+dataMonth;
		}
