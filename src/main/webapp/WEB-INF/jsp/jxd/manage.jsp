...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="jxd/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
        ...
        function add1(){
            ...
            diag.Drag=true;
            diag.Title ="申诉审核";
            diag.URL = '<%=basePath%>jxd/check.do';
            diag.Width = 1960;
            diag.Height = 1020;
            diag.CancelEvent = function(){ //关闭事件
                if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>jxd/goEdit.do?ID='+Id;
			 diag.Width = 1280;
			 diag.Height = 960;
			 diag.CancelEvent = function(){ //关闭事件
                 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>jxd/excel.do?dataMonth='+dataMonth;
		}
